...
Utilizando as duas funções acima, após um usuário sair do grupo é verificado(com o procedure, chamado por um trigger) se ele era líder do 
grupo, em caso positivo, o seu membro mais antigo vira o novo líder do grupo.
*/
DELIMITER $$
